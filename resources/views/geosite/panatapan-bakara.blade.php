...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .hero { height: 55vh; min-height: 450px; background: linear-gradient(rgba(0,51,102,0.6), rgba(0,51,102,0.7)), url('{{ asset('image/bakara/panatapan-bakara.jpg') }}'); background-size: cover; background-position: center; display: flex; align-items: center; justify-content: center; text-align: center; color: white; margin-top: 65px; }
...
<div class="info-praktis"><div class="info-praktis-grid"><div class="info-praktis-item"><h4>LOKASI</h4><p>Desa Bakara, Kec. Baktiraja</p></div><div class="info-praktis-item"><h4>JAM OPERASIONAL</h4><p>06:00 - 18:00 WIB</p></div><div class="info-praktis-item"><h4>HARGA TIKET</h4><p>Rp 5.000 - Rp 10.000</p></div></div><div class="tags"><span class="tag">Panorama Danau</span><span class="tag">Sunrise</span><span class="tag">Sunset</span><span class="tag">Spot Foto</span></div></div></div></section>
...
<div class="galeri-grid" id="galeriGrid">
    <div class="galeri-item" onclick="openLightbox('{{ asset('image/bakara/panatapan-bakara.jpg') }}')"><img src="{{ asset('image/bakara/panatapan-bakara.jpg') }}" alt="Panatapan 1"></div>
    <div class="galeri-item" onclick="openLightbox('{{ asset('image/bakara/panatapan-bakara-sunset.jpg') }}')"><img src="{{ asset('image/bakara/panatapan-bakara-sunset.jpg') }}" alt="Sunset"></div>
    <div class="galeri-item" onclick="openLightbox('{{ asset('image/bakara/desa-tipang.jpg') }}')"><img src="{{ asset('image/bakara/desa-tipang.jpg') }}" alt="Desa Tipang"></div>
    <div class="galeri-item" onclick="openLightbox('{{ asset('image/bakara/gonting.jpg') }}')"><img src="{{ asset('image/bakara/gonting.jpg') }}" alt="Gonting"></div>
</div></div></section>
...
<div class="umkm-grid">
    <div class="umkm-card"><div class="umkm-img"><img src="{{ asset('image/bakara/umkm/ulos.jpg') }}" alt="Ulos"></div><div class="umkm-content"><h4>Tenun Ulos Bakara</h4><p>✧ Sentra Tenun Bakara</p><p class="desc">Kain tradisional Batak dengan motif khas.</p></div></div>
    <div class="umkm-card"><div class="umkm-img"><img src="{{ asset('image/bakara/umkm/kopi.jpg') }}" alt="Kopi"></div><div class="umkm-content"><h4>Kopi Arabika Bakara</h4><p>✧ Perkebunan Kopi Bakara</p><p class="desc">Kopi arabika dengan cita rasa khas.</p></div></div>
    <div class="umkm-card"><div class="umkm-img"><img src="{{ asset('image/bakara/umkm/anyaman.jpg') }}" alt="Anyaman"></div><div class="umkm-content"><h4>Kerajinan Anyaman</h4><p>✧ Kerajinan Bakara</p><p class="desc">Anyaman bambu berkualitas.</p></div></div>
</div></div></section>
...
<section class="cta"><div class="container" data-aos="fade-up"><h3>Saksikan Keindahan Danau Toba dari Ketinggian</h3><div class="divider"></div><p>Panorama spektakuler yang akan membuat Anda terpukau</p><a href="{{ url('/destinasi') }}" class="cta-btn">Lihat Semua Destinasi</a></div></section>
