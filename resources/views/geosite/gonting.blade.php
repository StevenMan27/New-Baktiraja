...
<div class="galeri-grid" id="galeriGrid">
    ...
    <div class="galeri-item" onclick="openLightbox('{{ asset('image/bakara/istana-sisingamangaraja-detail.jpg') }}')"><img src="{{ asset('image/bakara/istana-sisingamangaraja-detail.jpg') }}" alt="Detail"></div>
    <div class="galeri-item" onclick="openLightbox('{{ asset('image/bakara/tombak-sulu-sulu.jpg') }}')"><img src="{{ asset('image/bakara/tombak-sulu-sulu.jpg') }}" alt="Tombak"></div>
...
<div class="umkm-grid">
    <div class="umkm-card"><div class="umkm-img"><img src="{{ asset('image/bakara/umkm/ulos.jpg') }}" alt="Ulos"></div><div class="umkm-content"><h4>Tenun Ulos Batak</h4><p>✧ Sentra Tenun Tipang</p><p class="desc">Kain tradisional Batak dengan motif khas.</p></div></div>
    <div class="umkm-card"><div class="umkm-img"><img src="{{ asset('image/bakara/umkm/kerajinan.jpg') }}" alt="Kerajinan"></div><div class="umkm-content"><h4>Ukiran Kayu Khas Batak</h4><p>✧ Kerajinan Bakara</p><p class="desc">Ukiran kayu dengan motif tradisional Batak.</p></div></div>
    <div class="umkm-card"><div class="umkm-img"><img src="{{ asset('image/bakara/umkm/kopi.jpg') }}" alt="Kopi"></div><div class="umkm-content"><h4>Kopi Arabika Tipang</h4><p>✧ Perkebunan Kopi</p><p class="desc">Kopi arabika dengan cita rasa khas.</p></div></div>
</div></div></section>
...
<div class="penginapan-grid">
    <div class="penginapan-card"><div class="penginapan-img"><img src="{{ asset('image/bakara/penginapan/homestay-bakara.jpg') }}" alt="Homestay"></div><div class="penginapan-content"><h4>Homestay Tipang</h4><p class="price">Rp 150.000 - Rp 250.000/malam</p><p class="desc">Menginap dengan pemandangan Danau Toba.</p></div></div>
    <div class="penginapan-card"><div class="penginapan-img"><img src="{{ asset('image/bakara/penginapan/tipang-hill.jpg') }}" alt="Resort"></div><div class="penginapan-content"><h4>Tipang Hill Resort</h4><p class="price">Rp 350.000 - Rp 500.000/malam</p><p class="desc">Resort dengan pemandangan spektakuler.</p></div></div>
