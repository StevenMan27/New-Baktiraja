...
<head>
    ...
    <title>Istana Sisingamangaraja - Wisata Bakara Tipang Baktiraja</title>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .hero { height: 55vh; min-height: 450px; background: linear-gradient(rgba(0,51,102,0.6), rgba(0,51,102,0.7)), url('{{ asset('image/bakara/istana-sisingamangaraja.jpg') }}'); background-size: cover; background-position: center; display: flex; align-items: center; justify-content: center; text-align: center; color: white; margin-top: 65px; }
        ...
        @media (max-width: 992px) { .umkm-grid, .penginapan-grid, .fasilitas-grid { grid-template-columns: repeat(2, 1fr); } .rekomendasi-grid { grid-template-columns: repeat(2, 1fr); } }
        @media (max-width: 768px) {
            ...
            .umkm-grid, .penginapan-grid, .fasilitas-grid { grid-template-columns: 1fr; } .rekomendasi-grid { grid-template-columns: 1fr; }
...
<section id="sejarah" class="section">
    <div class="container">
        ...
        <div class="sejarah-intro" style="margin-bottom: 50px; line-height: 1.8; color: #444; font-size: 0.95rem;">
            ...
            <p>Di Istana Sisingamangaraja, Anda dapat melihat berbagai artefak peninggalan kerajaan, termasuk senjata pusaka, pakaian adat, dan perlengkapan ritual. Arsitektur tradisional Batak yang masih terjaga dengan baik juga menjadi daya tarik tersendiri. Pengunjung dapat belajar tentang sistem pemerintahan, spiritualitas, dan kearifan lokal masyarakat Batak yang masih dilestarikan hingga saat ini.</p>
        </div>
        <div class="sejarah-grid">
            <div class="sejarah-item" data-aos="fade-right"><div class="sejarah-image"><img src="{{ asset('image/bakara/istana-sisingamangaraja-detail.jpg') }}" alt="Istana"></div><div class="sejarah-text"><h4 style="color: var(--bi-blue); margin-bottom: 12px; font-family: 'Cormorant Garamond', serif;">Sisingamangaraja XII: Pahlawan Nasional</h4><p>Sisingamangaraja XII diangkat menjadi Pahlawan Nasional Indonesia pada tahun 1961 berdasarkan SK Presiden RI No. 590 Tahun 1961. Beliau memimpin perang gerilya selama hampir 30 tahun melawan Belanda di tanah Batak. Perlawanannya yang tak kenal menyerah menginspirasi perjuangan kemerdekaan Indonesia di seluruh Sumatera Utara.</p></div></div>
            <div class="sejarah-item reverse" data-aos="fade-left"><div class="sejarah-image"><img src="{{ asset('image/bakara/istana-sisingamangaraja.jpg') }}" alt="Arsitektur"></div><div class="sejarah-text"><h4 style="color: var(--bi-blue); margin-bottom: 12px; font-family: 'Cormorant Garamond', serif;">Arsitektur Tradisional Batak yang Autentik</h4><p>Istana Sisingamangaraja dibangun dengan arsitektur tradisional Batak Toba yang khas. Rumah adat dengan bentuk gonjong (atap melengkung), ukiran-ukiran filosofis, dan tiang-tiang penyangga yang kokoh. Setiap elemen bangunan memiliki makna dan filosofi tersendiri dalam kepercayaan dan adat istiadat Batak.</p></div></div>
            <div class="sejarah-item" data-aos="fade-right"><div class="sejarah-image"><img src="{{ asset('image/bakara/tombak-sulu-sulu.jpg') }}" alt="Ritual"></div><div class="sejarah-text"><h4 style="color: var(--bi-blue); margin-bottom: 12px; font-family: 'Cormorant Garamond', serif;">Pusat Spiritual dan Ritual Adat</h4><p>Hingga saat ini, Istana Sisingamangaraja masih digunakan sebagai tempat pelaksanaan ritual adat oleh masyarakat Batak. Upacara seperti mangupa (syukuran), martutu aek (upacara adat perkawinan), dan ritual lainnya masih sering dilakukan di sini. Pengunjung yang datang diharapkan menghormati adat dan tradisi setempat.</p></div></div>
        </div>
    </div>
</section>
...
<div class="info-praktis"><div class="info-praktis-grid"><div class="info-praktis-item"><h4>LOKASI</h4><p>Tipang, Kec. Baktiraja</p></div><div class="info-praktis-item"><h4>JAM OPERASIONAL</h4><p>08:00 - 17:00 WIB</p></div><div class="info-praktis-item"><h4>HARGA TIKET</h4><p>Rp 10.000 - Rp 15.000</p></div></div><div class="tags"><span class="tag">Istana</span><span class="tag">Sejarah Batak</span><span class="tag">Raja Sisingamangaraja</span><span class="tag">Ritual Adat</span><span class="tag">Artefak</span></div></div></div></section>
...
<section id="rekomendasi" class="section"><div class="container"><div class="section-title" data-aos="fade-up"><h2>Destinasi Lain di Sekitar</h2><div class="divider"></div></div>
<div class="rekomendasi-grid">
    ...
    <div class="rekomendasi-card" onclick="window.location.href='{{ url('/geosite/tombak-sulu-sulu') }}'"><div class="rekomendasi-img"><img src="{{ asset('image/bakara/tombak-sulu-sulu.jpg') }}" alt="Tombak"></div><div class="rekomendasi-content"><h4>Tombak Sulu-sulu</h4><p>Hutan Sakral</p></div></div>
...
<section id="maps" class="section bg-light"><div class="container"><div class="section-title" data-aos="fade-up"><h2>Lokasi Kami</h2><div class="divider"></div></div>
<div class="maps-container" data-aos="zoom-in">
    ...
    <div class="maps-info"><p><i class="fas fa-map-marker-alt"></i> Istana Sisingamangaraja, Tipang, Kecamatan Baktiraja, Kabupaten Humbang Hasundutan, Sumatera Utara</p></div>
</div></div></section>
