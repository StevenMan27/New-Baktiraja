...
<head>
    ...
    <title>Desa Wisata Tipang - Wisata Bakara Tipang Baktiraja</title>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .hero { height: 55vh; min-height: 450px; background: linear-gradient(rgba(0,51,102,0.6), rgba(0,51,102,0.7)), url('{{ asset('image/bakara/desa-tipang.jpg') }}'); background-size: cover; background-position: center; display: flex; align-items: center; justify-content: center; text-align: center; color: white; margin-top: 65px; }
        .hero-title { font-size: 2.8rem; font-family: 'Cormorant Garamond', serif; margin-bottom: 12px; }
...
<div class="info-praktis"><div class="info-praktis-grid"><div class="info-praktis-item"><h4>LOKASI</h4><p>Tipang, Kec. Baktiraja</p></div><div class="info-praktis-item"><h4>JAM OPERASIONAL</h4><p>08:00 - 18:00 WIB</p></div><div class="info-praktis-item"><h4>HARGA TIKET</h4><p>Rp 5.000 - Rp 10.000</p></div></div><div class="tags"><span class="tag">Desa Wisata</span><span class="tag">Homestay</span><span class="tag">Budaya Batak</span><span class="tag">Panorama</span></div></div></div></section>
...
<div class="galeri-grid" id="galeriGrid">
    <div class="galeri-item" onclick="openLightbox('{{ asset('image/bakara/desa-tipang.jpg') }}')"><img src="{{ asset('image/bakara/desa-tipang.jpg') }}" alt="Desa Tipang 1"></div>
    <div class="galeri-item" onclick="openLightbox('{{ asset('image/bakara/homestay-bakara.jpg') }}')"><img src="{{ asset('image/bakara/homestay-bakara.jpg') }}" alt="Homestay"></div>
    ...
    <div class="galeri-item" onclick="openLightbox('{{ asset('image/bakara/aek-sitio-tio.jpg') }}')"><img src="{{ asset('image/bakara/aek-sitio-tio.jpg') }}" alt="Aek Sitio-tio"></div>
</div></div></section>
...
<div class="umkm-grid">
    <div class="umkm-card"><div class="umkm-img"><img src="{{ asset('image/bakara/umkm/ulos.jpg') }}" alt="Tenun Ulos"></div><div class="umkm-content"><h4>Tenun Ulos Khas Batak</h4><p>✧ Sentra Tenun Tipang</p><p class="desc">Kain tradisional Batak dengan motif khas yang dibuat secara manual.</p></div></div>
    <div class="umkm-card"><div class="umkm-img"><img src="{{ asset('image/bakara/umkm/kopi.jpg') }}" alt="Kopi Tipang"></div><div class="umkm-content"><h4>Kopi Arabika Tipang</h4><p>✧ Perkebunan Kopi Tipang</p><p class="desc">Kopi arabika dengan cita rasa khas dari perkebunan warga Tipang.</p></div></div>
    <div class="umkm-card"><div class="umkm-img"><img src="{{ asset('image/bakara/umkm/anyaman.jpg') }}" alt="Anyaman"></div><div class="umkm-content"><h4>Anyaman Bambu</h4><p>✧ Kerajinan Tipang</p><p class="desc">Kerajinan tangan dari anyaman bambu berkualitas.</p></div></div>
</div></div></section>
...
<div class="penginapan-grid">
    <div class="penginapan-card"><div class="penginapan-img"><img src="{{ asset('image/bakara/penginapan/homestay-bakara.jpg') }}" alt="Homestay"></div><div class="penginapan-content"><h4>Homestay Tipang</h4><p class="price">Rp 150.000 - Rp 250.000/malam</p><p class="desc">Menginap bersama keluarga Batak dengan pemandangan Danau Toba.</p></div></div>
    <div class="penginapan-card"><div class="penginapan-img"><img src="{{ asset('image/bakara/penginapan/tipang-hill.jpg') }}" alt="Tipang Hill"></div><div class="penginapan-content"><h4>Tipang Hill Resort</h4><p class="price">Rp 350.000 - Rp 500.000/malam</p><p class="desc">Resort dengan pemandangan langsung ke Danau Toba.</p></div></div>
    <div class="penginapan-card"><div class="penginapan-img"><img src="{{ asset('image/bakara/penginapan/camping-gonting.jpg') }}" alt="Camping"></div><div class="penginapan-content"><h4>Camping Ground Tipang</h4><p class="price">Rp 50.000 - Rp 100.000/malam</p><p class="desc">Area camping dengan pemandangan alam yang asri.</p></div></div>
</div></div></section>
...
<div class="rekomendasi-grid">
    <div class="rekomendasi-card" onclick="window.location.href='{{ url('/geosite/panatapan-bakara') }}'"><div class="rekomendasi-img"><img src="{{ asset('image/bakara/panatapan-bakara.jpg') }}" alt="Panatapan"></div><div class="rekomendasi-content"><h4>Panatapan Bakara</h4><p>Panorama Danau Toba</p></div></div>
...
<div class="maps-container" data-aos="zoom-in">
    ...
    <div class="maps-info"><p><i class="fas fa-map-marker-alt"></i> Desa Wisata Tipang, Kecamatan Baktiraja, Kabupaten Humbang Hasundutan</p></div>
</div></div></section>

<section class="cta"><div class="container" data-aos="fade-up"><h3>Rasakan Pengalaman Menginap di Desa Tipang</h3><div class="divider"></div><p>Desa wisata dengan pemandangan spektakuler dan keramahan khas Batak</p><a href="{{ url('/destinasi') }}" class="cta-btn">Lihat Semua Destinasi</a></div></section>
