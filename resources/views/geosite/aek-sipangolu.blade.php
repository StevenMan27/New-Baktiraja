...
<head>
    ...
    <title>Aek Sipangolu - Wisata Bakara Tipang Baktiraja</title>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .hero { height: 55vh; min-height: 450px; background: linear-gradient(rgba(0,51,102,0.6), rgba(0,51,102,0.7)), url('{{ asset('image/bakara/aek-sipangolu.jpg') }}'); background-size: cover; background-position: center; display: flex; align-items: center; justify-content: center; text-align: center; color: white; margin-top: 65px; }
...
<div class="info-praktis"><div class="info-praktis-grid"><div class="info-praktis-item"><h4>LOKASI</h4><p>Baktiraja</p></div><div class="info-praktis-item"><h4>JAM OPERASIONAL</h4><p>07:00 - 18:00 WIB</p></div><div class="info-praktis-item"><h4>HARGA TIKET</h4><p>Rp 10.000 - Rp 20.000</p></div></div><div class="tags"><span class="tag">Mata Air Panas</span><span class="tag">Pengobatan Tradisional</span><span class="tag">Wisata Spiritual</span><span class="tag">Belerang</span></div></div></div></section>
...
<div class="galeri-grid" id="galeriGrid">
    <div class="galeri-item" onclick="openLightbox('{{ asset('image/bakara/aek-sipangolu.jpg') }}')"><img src="{{ asset('image/bakara/aek-sipangolu.jpg') }}" alt="Aek Sipangolu 1"></div>
    <div class="galeri-item" onclick="openLightbox('{{ asset('image/bakara/aek-sipangolu-detail.jpg') }}')"><img src="{{ asset('image/bakara/aek-sipangolu-detail.jpg') }}" alt="Detail"></div>
...
<div class="maps-container" data-aos="zoom-in">
    ...
    <div class="maps-info"><p><i class="fas fa-map-marker-alt"></i> Aek Sipangolu, Baktiraja, Kabupaten Humbang Hasundutan, Sumatera Utara</p></div>
</div></div></section>

<section class="cta"><div class="container" data-aos="fade-up"><h3>Rasakan Khasiat Air Pereda Penat</h3><div class="divider"></div><p>Aek Sipangolu: mata air panas alami dengan legenda dan khasiat penyembuhan</p><a href="{{ url('/destinasi') }}" class="cta-btn">Lihat Semua Destinasi</a></div></section>
