...
<head>
    ...
    <title>Tombak Sulu-sulu - Wisata Bakara Tipang Baktiraja</title>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .hero { height: 55vh; min-height: 450px; background: linear-gradient(rgba(0,51,102,0.6), rgba(0,51,102,0.7)), url('{{ asset('image/bakara/tombak-sulu-sulu.jpg') }}'); background-size: cover; background-position: center; display: flex; align-items: center; justify-content: center; text-align: center; color: white; margin-top: 65px; }
...
<div class="navbar">
    <div class="nav-container">
        ...
        <div class="nav-menu">
            <a href="#sejarah" class="nav-link">Legenda</a>
...
<div class="mobile-overlay" id="mobileOverlay">
    ...
    <a href="#sejarah" class="mobile-link">Legenda</a>
...
<div class="info-praktis"><div class="info-praktis-grid"><div class="info-praktis-item"><h4>LOKASI</h4><p>Kawasan Bakara</p></div><div class="info-praktis-item"><h4>JAM OPERASIONAL</h4><p>08:00 - 17:00 WIB</p></div><div class="info-praktis-item"><h4>HARGA TIKET</h4><p>Rp 5.000 - Rp 10.000</p></div></div><div class="tags"><span class="tag">Hutan Sakral</span><span class="tag">Legenda</span><span class="tag">Wisata Spiritual</span><span class="tag">Trekking</span></div></div></div></section>
...
<div class="galeri-grid" id="galeriGrid">
    <div class="galeri-item" onclick="openLightbox('{{ asset('image/bakara/tombak-sulu-sulu.jpg') }}')"><img src="{{ asset('image/bakara/tombak-sulu-sulu.jpg') }}" alt="Tombak 1"></div>
    <div class="galeri-item" onclick="openLightbox('{{ asset('image/bakara/tombak-sulu-sulu-forest.jpg') }}')"><img src="{{ asset('image/bakara/tombak-sulu-sulu-forest.jpg') }}" alt="Hutan"></div>
    <div class="galeri-item" onclick="openLightbox('{{ asset('image/bakara/istana-sisingamangaraja.jpg') }}')"><img src="{{ asset('image/bakara/istana-sisingamangaraja.jpg') }}" alt="Istana"></div>
...
<div class="umkm-grid">
    <div class="umkm-card"><div class="umkm-img"><img src="{{ asset('image/bakara/umkm/kerajinan.jpg') }}" alt="Kerajinan"></div><div class="umkm-content"><h4>Kerajinan Ukiran Kayu</h4><p>✧ Pengrajin Bakara</p><p class="desc">Ukiran kayu dengan motif tradisional Batak dan miniatur tombak pusaka.</p></div></div>
    <div class="umkm-card"><div class="umkm-img"><img src="{{ asset('image/bakara/umkm/ulos.jpg') }}" alt="Ulos"></div><div class="umkm-content"><h4>Tenun Ulos Batak</h4><p>✧ Sentra Tenun Bakara</p><p class="desc">Kain tradisional Batak dengan motif khas.</p></div></div>
    <div class="umkm-card"><div class="umkm-img"><img src="{{ asset('image/bakara/umkm/madu.jpg') }}" alt="Madu"></div><div class="umkm-content"><h4>Madu Hutan Bakara</h4><p>✧ Kelompok Tani Bakara</p><p class="desc">Madu alami dari hutan sekitar kawasan.</p></div></div>
</div></div></section>
...
<div class="penginapan-grid">
    <div class="penginapan-card"><div class="penginapan-img"><img src="{{ asset('image/bakara/penginapan/homestay-bakara.jpg') }}" alt="Homestay"></div><div class="penginapan-content"><h4>Homestay Bakara</h4><p class="price">Rp 150.000 - Rp 250.000/malam</p><p class="desc">Menginap dengan pemandangan Danau Toba.</p></div></div>
    <div class="penginapan-card"><div class="penginapan-img"><img src="{{ asset('image/bakara/penginapan/tipang-hill.jpg') }}" alt="Resort"></div><div class="penginapan-content"><h4>Bakara Hill Resort</h4><p class="price">Rp 350.000 - Rp 500.000/malam</p><p class="desc">Resort dengan pemandangan spektakuler.</p></div></div>
    <div class="penginapan-card"><div class="penginapan-img"><img src="{{ asset('image/bakara/penginapan/camping-gonting.jpg') }}" alt="Camping"></div><div class="penginapan-content"><h4>Camping Ground Bakara</h4><p class="price">Rp 50.000 - Rp 100.000/malam</p><p class="desc">Area camping dengan pemandangan alam.</p></div></div>
</div></div></section>
...
<div class="rekomendasi-grid">
    <div class="rekomendasi-card" onclick="window.location.href='{{ url('/geosite/panatapan-bakara') }}'"><div class="rekomendasi-img"><img src="{{ asset('image/bakara/panatapan-bakara.jpg') }}" alt="Panatapan"></div><div class="rekomendasi-content"><h4>Panatapan Bakara</h4><p>Panorama Danau</p></div></div>
...
<div class="maps-container" data-aos="zoom-in">
    ...
    <div class="maps-info"><p><i class="fas fa-map-marker-alt"></i> Hutan Sakral Tombak Sulu-sulu, Kawasan Bakara, Kecamatan Baktiraja, Kabupaten Humbang Hasundutan</p></div>
</div></div></section>

<section class="cta"><div class="container" data-aos="fade-up"><h3>Jelajahi Misteri Hutan Sakral Tombak Sulu-sulu</h3><div class="divider"></div><p>Legenda pusaka Sisingamangaraja yang masih tersimpan rapat</p><a href="{{ url('/destinasi') }}" class="cta-btn">Lihat Semua Destinasi</a></div></section>
