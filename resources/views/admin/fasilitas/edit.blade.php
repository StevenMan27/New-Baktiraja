...
{{--
   ======================================================================================
   [PENJELASAN LENGKAP FILE: a:/PA111/real/New folder/Proyek akhir 1 Real/resources/views/admin/fasilitas/edit.blade.php]
...
<style>
    ...
    /* Warna ikon section harga berwarna kuning */
    .icon-price  { background: #fef3c7; color: #d97706; }
...
<div class="ep-wrapper">
    ...
    {{-- Banner header halaman dengan tombol kembali ke daftar fasilitas --}}
    <div class="hp-page-header">
        <div class="hp-page-header-left">
            <div class="icon-wrap"><i class="fas fa-concierge-bell"></i></div>
            <div>
                <h4>Edit Fasilitas</h4>
                <p>Perbarui informasi dan data fasilitas di Geosite Danau Toba</p>
            </div>
        </div>
        {{-- Tombol kembali menuju halaman daftar fasilitas --}}
        <a href="{{ route('admin.fasilitas.index') }}" class="hp-btn-back">
            <i class="fas fa-arrow-left"></i> Kembali
        </a>
    </div>

    {{-- Form utama pengiriman data edit fasilitas --}}
    <form action="{{ route('admin.fasilitas.update', $data->id) }}" method="POST" enctype="multipart/form-data" id="formFasilitas">
        @csrf
        @method('PUT')

        {{-- Section informasi dasar fasilitas berisi nama dan pilihan geosite --}}
        <div class="hp-section">
            <div class="hp-section-header">
                <div class="section-icon icon-info"><i class="fas fa-info-circle"></i></div>
                <div>
                    <h6>Informasi Dasar</h6>
                    <p>Nama fasilitas dan geosite yang dituju</p>
                </div>
            </div>
        ...
        {{-- Section deskripsi fasilitas berisi textarea penjelasan fasilitas --}}
        <div class="hp-section">
            <div class="hp-section-header">
                <div class="section-icon icon-desc"><i class="fas fa-align-left"></i></div>
                <div>
                    <h6>Deskripsi Fasilitas</h6>
                    <p>Penjelasan singkat mengenai fasilitas ini</p>
                </div>
            </div>
            <div class="hp-section-body">
                <div>
                    ...
                    <textarea name="deskripsi"
                        ...
                        rows="4"
                        placeholder="Masukkan deskripsi fasilitas" required>{{ old('deskripsi', $data->deskripsi) }}</textarea>
                    @error('deskripsi')
                        <div class="hp-error"><i class="fas fa-exclamation-circle"></i> {{ $message }}</div>
                    @enderror
                </div>
        ...
        {{-- Section harga fasilitas berisi input tarif yang berlaku --}}
        <div class="hp-section">
            <div class="hp-section-header">
                <div class="section-icon icon-price"><i class="fas fa-tag"></i></div>
                <div>
                    <h6>Informasi Harga</h6>
                    <p>Tarif atau harga penggunaan fasilitas</p>
                </div>
            </div>
            <div class="hp-section-body">
                <div>
                    ...
                    <input type="text" name="harga"
                        ...
                        placeholder="cth: Rp 50.000 / orang">
                    @error('harga')
                        <div class="hp-error"><i class="fas fa-exclamation-circle"></i> {{ $message }}</div>
                    @enderror
                </div>
        ...
        {{-- Section upload gambar fasilitas berisi gambar lama dan area upload baru --}}
        <div class="hp-section">
            <div class="hp-section-header">
                <div class="section-icon icon-media"><i class="fas fa-image"></i></div>
                <div>
                    <h6>Gambar Fasilitas</h6>
                    <p>Unggah gambar utama untuk fasilitas ini</p>
                </div>
            </div>
            <div class="hp-section-body">
                @php
            ...
            <div class="hp-save-bar">
                <span class="hp-save-hint"><i class="fas fa-lock me-1"></i> Perubahan fasilitas akan langsung tersimpan ke sistem</span>
                <div style="display:flex; gap:10px; align-items:center;">
                    {{-- Tombol batal kembali ke halaman daftar fasilitas --}}
                    <a href="{{ route('admin.fasilitas.index') }}" class="hp-btn-cancel">
                        <i class="fas fa-times"></i> Batal
                    </a>
                    {{-- Tombol submit menyimpan perubahan data fasilitas --}}
