...
<div class="ep-wrapper">
    ...
    {{-- Header halaman edit fasilitas dengan tombol kembali --}}
    {{-- Gradient biru dengan ikon, judul, dan link kembali ke daftar --}}
    ...
    {{-- Form edit fasilitas: informasi dasar, deskripsi, harga, gambar, dan save bar --}}
    ...
    <form action="{{ route('admin.fasilitas.update', $data->id) }}" method="POST" enctype="multipart/form-data" id="formFasilitas">
        ...
        {{-- Section gambar fasilitas: tampilkan gambar tersimpan dan area upload baru --}}
...
// Validasi ukuran file dan tampilkan thumbnail preview saat input file berubah
<script>
