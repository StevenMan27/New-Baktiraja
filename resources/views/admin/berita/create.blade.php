...
{{--
   ======================================================================================
   [PENJELASAN LENGKAP FILE: a:/PA111/real/New folder/Proyek akhir 1 Real/resources/views/admin/berita/create.blade.php]
...
<style>
    ...
    /* Warna ikon section konten artikel hijau */
    .icon-konten { background: #f0fdf4; color: #16a34a; }
...
<div class="ep-wrapper">
    ...
    <div class="hp-page-header">
        <div class="hp-page-header-left">
            ...
            <div>
                ...
                <p>Buat dan publikasikan artikel berita GeoToba Baktiraja</p>
            </div>
        </div>
    ...
    {{-- Form utama pengiriman data berita baru --}}
    <form action="{{ route('admin.berita.store') }}" method="POST" enctype="multipart/form-data">
        @csrf

        {{-- Section informasi dasar berita --}}
        <div class="hp-section">
            ...
            <div class="hp-section-body">
                ...
                <div class="hp-grid-2">
                    <div>
                        <label class="hp-label">Pilih Geosite <span style="color:var(--danger)">*</span></label>
        ...
        {{-- Section konten artikel berita --}}
        <div class="hp-section">
            <div class="hp-section-header">
                <div class="section-icon icon-konten"><i class="fas fa-align-left"></i></div>
                <div>
                    <h6>Konten Berita</h6>
                    <p>Isi artikel berita secara lengkap</p>
                </div>
            </div>
            <div class="hp-section-body">
        ...
        {{-- Section upload gambar berita --}}
        <div class="hp-section">
            <div class="hp-section-header">
                <div class="section-icon icon-media"><i class="fas fa-image"></i></div>
                <div>
                    <h6>Gambar Berita</h6>
                    <p>Unggah satu gambar sebagai sampul berita</p>
                </div>
            </div>
            <div class="hp-section-body">
            ...
            <div class="hp-save-bar">
                <span class="hp-save-hint"><i class="fas fa-lock me-1"></i> Berita akan langsung tersimpan ke sistem</span>
                <div style="display:flex; gap:10px; align-items:center;">
                    {{-- Tombol batal kembali ke halaman daftar berita --}}
                    <a href="{{ route('admin.berita.index') }}" class="hp-btn-cancel">
                        <i class="fas fa-times"></i> Batal
                    </a>
                    {{-- Tombol submit menyimpan data berita baru --}}
...
<script>
    document.getElementById('inputGambar').addEventListener('change', function(e) {
        ...
        /* Hentikan proses bila tidak ada file yang dipilih */
        if (!file) return;
