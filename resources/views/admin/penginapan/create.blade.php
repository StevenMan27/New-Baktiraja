{{--
   ======================================================================================
   [PENJELASAN LENGKAP FILE: a:/PA111/real/New folder/Proyek akhir 1 Real/resources/views/admin/penginapan/create.blade.php]
...
<style>
    ...
    /* Warna ikon section harga dan kontak kuning */
    ...
    <div class="hp-page-header">
        <div class="hp-page-header-left">
            ...
            <div>
                ...
                <p>Isi nama, geosite, deskripsi, dan detail penginapan</p>
            </div>
        </div>
        {{-- Tombol kembali ke halaman daftar penginapan --}}
        <a href="{{ route('admin.penginapan.index') }}" class="hp-btn-back">
            <i class="fas fa-arrow-left"></i> Kembali
        </a>
    </div>

    {{-- Form utama pengiriman data penginapan baru --}}
    <form action="{{ route('admin.penginapan.store') }}" method="POST" enctype="multipart/form-data" id="formPenginapan">
        @csrf
        ...
        <div class="hp-section">
            <div class="hp-section-header">
                ...
                <div>
                    ...
                    <p>Nama, geosite, dan deskripsi penginapan</p>
                </div>
            </div>
            <div class="hp-section-body">
                <div class="hp-grid-2" style="margin-bottom: 16px;">
                    <div>
                        <label class="hp-label">Nama Penginapan <span style="color:var(--danger)">*</span></label>
                    ...
                    <div>
                        ...
                        <select name="geosite"
                            ...
                            @foreach($geositeList as $value => $label)
                                <option value="{{ $value }}" {{ old('geosite') == $value ? 'selected' : '' }}>
                                    {{ $label }}
                                </option>
                            @endforeach
                        </select>
                ...
                <div>
                    ...
                    <textarea name="deskripsi"
                        ...
                        rows="4"
                        placeholder="Masukkan deskripsi penginapan" required>{{ old('deskripsi') }}</textarea>
                    @error('deskripsi')
                        <div class="hp-error"><i class="fas fa-exclamation-circle"></i> {{ $message }}</div>
                    @enderror
                </div>
        ...
        {{-- Section upload gambar penginapan --}}
        <div class="hp-section">
            <div class="hp-section-header">
                <div class="section-icon icon-media"><i class="fas fa-image"></i></div>
                <div>
                    <h6>Gambar</h6>
                    <p>Unggah gambar pendukung penginapan</p>
                </div>
            </div>
            <div class="hp-section-body">
        ...
        <div class="hp-section">
                ...
                <div class="hp-grid-2">
                    <div>
                        ...
                        <input type="text" name="harga"
                            ...
                            value="{{ old('harga') }}"
                            placeholder="Contoh: Rp 150.000 / malam">
                        @error('harga')
                            <div class="hp-error"><i class="fas fa-exclamation-circle"></i> {{ $message }}</div>
                        @enderror
                    </div>
            ...
            <div class="hp-save-bar">
                <span class="hp-save-hint"><i class="fas fa-lock me-1"></i> Data penginapan akan langsung tersimpan ke sistem</span>
                <div style="display:flex; gap:10px; align-items:center;">
                    {{-- Tombol batal kembali ke halaman daftar penginapan --}}
                    <a href="{{ route('admin.penginapan.index') }}" class="hp-btn-cancel">
                        <i class="fas fa-times"></i> Batal
                    </a>
                    {{-- Tombol submit menyimpan data penginapan baru --}}
