...
{{--
   ======================================================================================
   [PENJELASAN LENGKAP FILE: a:/PA111/real/New folder/Proyek akhir 1 Real/resources/views/admin/penginapan/edit.blade.php]
    ...
    <form action="{{ route('admin.penginapan.update', $data->id) }}" method="POST" enctype="multipart/form-data" id="formPenginapan">
        ...
        <div class="hp-section">
            <div class="hp-section-header">
                ...
                <div>
                    ...
                    <p>Nama penginapan dan geosite yang dituju</p>
                </div>
            </div>
                    ...
                    <div>
                        ...
                        <select name="geosite"
                            ...
                            @foreach($geositeList as $value => $label)
                                <option value="{{ $value }}" {{ old('geosite', $data->geosite) == $value ? 'selected' : '' }}>
                                    {{ $label }}
                                </option>
                            @endforeach
                        </select>
        ...
        <div class="hp-section">
            <div class="hp-section-header">
                ...
                <div>
                    <h6>Deskripsi Penginapan</h6>
                    <p>Penjelasan singkat mengenai penginapan ini</p>
                </div>
            </div>
            <div class="hp-section-body">
                <div>
                    ...
                    <textarea name="deskripsi"
                        ...
                        rows="4"
                        placeholder="Masukkan deskripsi penginapan" required>{{ old('deskripsi', $data->deskripsi) }}</textarea>
                    @error('deskripsi')
                        <div class="hp-error"><i class="fas fa-exclamation-circle"></i> {{ $message }}</div>
                    @enderror
                </div>
        ...
        <div class="hp-section">
            <div class="hp-section-header">
                ...
                <div>
                    <h6>Harga dan Kontak</h6>
                    <p>Tarif menginap dan informasi kontak penginapan</p>
                </div>
            </div>
            <div class="hp-section-body">
                <div class="hp-grid-2">
                    <div>
                        ...
                        <input type="text" name="harga"
                            ...
                            placeholder="cth: Rp 150.000 / malam">
                        @error('harga')
                            <div class="hp-error"><i class="fas fa-exclamation-circle"></i> {{ $message }}</div>
                        @enderror
                    </div>
        ...
        <div class="hp-section">
            <div class="hp-section-header">
                ...
                <div>
                    <h6>Gambar Penginapan</h6>
                    <p>Unggah gambar utama untuk penginapan ini</p>
                </div>
            </div>
            <div class="hp-section-body">
                @php
