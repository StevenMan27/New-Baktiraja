{{--
   ======================================================================================
   [PENJELASAN LENGKAP FILE: a:/PA111/real/New folder/Proyek akhir 1 Real/resources/views/admin/informasi/create.blade.php]
...
<style>
    ...
    /* Warna ikon section konten hijau */
    ...
    <div class="hp-page-header">
        <div class="hp-page-header-left">
            ...
            <div>
                ...
                <p>Isi judul, geosite, gambar, dan konten informasi</p>
            </div>
        </div>
        {{-- Tombol kembali ke halaman daftar informasi --}}
        <a href="{{ route('admin.informasi.index') }}" class="hp-btn-back">
            <i class="fas fa-arrow-left"></i> Kembali
        </a>
    </div>

    {{-- Form utama pengiriman data informasi baru --}}
    <form action="{{ route('admin.informasi.store') }}" method="POST" enctype="multipart/form-data" id="formInformasi">
        @csrf

        {{-- Section informasi dasar judul dan geosite --}}
        <div class="hp-section">
            <div class="hp-section-header">
                <div class="section-icon icon-info"><i class="fas fa-info-circle"></i></div>
                <div>
                    <h6>Informasi Dasar</h6>
                    <p>Judul dan geosite terkait informasi</p>
                </div>
            </div>
        ...
        {{-- Section upload gambar informasi --}}
        <div class="hp-section">
            <div class="hp-section-header">
                <div class="section-icon icon-media"><i class="fas fa-image"></i></div>
                <div>
                    <h6>Gambar</h6>
                    <p>Unggah gambar pendukung informasi</p>
                </div>
            </div>
            <div class="hp-section-body">
        ...
        {{-- Section konten isi informasi --}}
        <div class="hp-section">
            <div class="hp-section-header">
                <div class="section-icon icon-content"><i class="fas fa-align-left"></i></div>
                <div>
                    <h6>Konten</h6>
                    <p>Isi lengkap informasi yang akan ditampilkan</p>
                </div>
            </div>
            <div class="hp-section-body">
                ...
                <textarea name="konten"
                    ...
                    rows="12"
                    placeholder="Masukkan isi konten informasi" required>{{ old('konten') }}</textarea>
                @error('konten')
                    <div class="hp-error"><i class="fas fa-exclamation-circle"></i> {{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="hp-save-bar">
                <span class="hp-save-hint"><i class="fas fa-lock me-1"></i> Data informasi akan langsung tersimpan ke sistem</span>
                <div style="display:flex; gap:10px; align-items:center;">
                    {{-- Tombol batal kembali ke halaman daftar informasi --}}
                    <a href="{{ route('admin.informasi.index') }}" class="hp-btn-cancel">
                        <i class="fas fa-times"></i> Batal
                    </a>
                    {{-- Tombol submit menyimpan data informasi baru --}}
