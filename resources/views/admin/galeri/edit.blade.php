{{--
   ======================================================================================
   [PENJELASAN LENGKAP FILE: a:/PA111/real/New folder/Proyek akhir 1 Real/resources/views/admin/galeri/edit.blade.php]
...
<style>
    ...
    /* Warna ikon section detail tambahan kuning */
    ...
    /* Grid wrapper gambar yang sudah tersimpan di database menggunakan flex wrap */
    ...
    /* Item gambar yang sudah tersimpan menampilkan gambar sesuai proporsi aslinya */
    ...
    /* Grid preview gambar baru yang dipilih sebelum disimpan */
    .new-preview-grid {
        display: flex;
        flex-wrap: wrap;
        gap: 10px;
    ...
    /* Item preview individual gambar baru */
    .new-preview-grid .preview-item {
        pointer-events: auto;
    }

    /* Gambar baru yang dipilih ditampilkan sesuai proporsi aslinya tanpa dipaksa kotak */
...
<div class="ep-wrapper">
    ...
    <div class="hp-page-header">
        ...
        {{-- Tombol kembali ke halaman daftar galeri --}}
        <a href="{{ route('admin.galeri.index') }}" class="hp-btn-back">
            <i class="fas fa-arrow-left"></i> Kembali
        </a>
    </div>

    {{-- Form utama pengiriman data edit galeri --}}
    <form action="{{ route('admin.galeri.update', $galeri->id) }}" method="POST" enctype="multipart/form-data" id="formGaleri">
        @csrf
        @method('PUT')

        {{-- Section informasi dasar galeri --}}
        <div class="hp-section">
            <div class="hp-section-header">
                <div class="section-icon icon-info"><i class="fas fa-info-circle"></i></div>
                <div>
                    <h6>Informasi Dasar</h6>
                    <p>Judul, geosite, dan deskripsi galeri</p>
                </div>
            </div>
                    ...
                    <div>
                        ...
                        <select name="geosite"
                            ...
                            @foreach($geositeList as $slug => $label)
                                <option value="{{ $slug }}" {{ (old('geosite', $galeri->geosite) == $slug) ? 'selected' : '' }}>
                                    {{ $label }}
                                </option>
                            @endforeach
                        </select>
        ...
        {{-- Section upload gambar galeri --}}
        <div class="hp-section">
            <div class="hp-section-header">
                <div class="section-icon icon-media"><i class="fas fa-images"></i></div>
                <div>
                    <h6>Gambar Galeri</h6>
                    <p>Unggah satu atau beberapa gambar sekaligus</p>
                </div>
            </div>
            <div class="hp-section-body">
                @php
                ...
                {{-- Tampilkan gambar tersimpan dengan proporsi asli tanpa dipaksa kotak --}}
                @if(count($images) > 0)
                ...
                <div class="upload-zone">
                    ...
                    {{-- Grid preview gambar baru yang dipilih ditampilkan sesuai proporsi aslinya --}}
        ...
        {{-- Section informasi detail tambahan lokasi dan tanggal --}}
        <div class="hp-section">
            <div class="hp-section-header">
                <div class="section-icon icon-detail"><i class="fas fa-map-marker-alt"></i></div>
                <div>
                    <h6>Detail Tambahan</h6>
                    <p>Lokasi pengambilan foto dan tanggal</p>
                </div>
            </div>
            <div class="hp-section-body">
                <div class="hp-grid-2">
                    ...
                    <div>
                        ...
                        <input type="date" name="tanggal_foto"
                            class="hp-input {{ $errors->has('tanggal_foto') ? 'is-invalid' : '' }}"
            ...
            <div class="hp-save-bar">
                <span class="hp-save-hint"><i class="fas fa-lock me-1"></i> Perubahan galeri akan langsung tersimpan ke sistem</span>
                <div style="display:flex; gap:10px; align-items:center;">
                    {{-- Tombol batal kembali ke halaman daftar galeri --}}
                    <a href="{{ route('admin.galeri.index') }}" class="hp-btn-cancel">
                        <i class="fas fa-times"></i> Batal
                    </a>
                    {{-- Tombol submit menyimpan perubahan data galeri --}}
...
{{-- Script preview gambar baru sebelum diupload, berjalan saat file dipilih --}}
<script>
    document.getElementById('inputGambar').addEventListener('change', function(e) {
        ...
        /* Iterasi setiap file dan tampilkan thumbnail preview sesuai proporsi aslinya */
