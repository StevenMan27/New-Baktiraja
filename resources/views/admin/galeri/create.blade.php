{{--
   ======================================================================================
   [PENJELASAN LENGKAP FILE: a:/PA111/real/New folder/Proyek akhir 1 Real/resources/views/admin/galeri/create.blade.php]
...
<div class="ep-wrapper">
    ...
    <div class="hp-page-header">
        <div class="hp-page-header-left">
            ...
            <div>
                <h4>Tambah Galeri Baru</h4>
                <p>Unggah foto dan informasi galeri GeoToba Baktiraja</p>
            </div>
        </div>
    ...
    {{-- Form utama pengiriman data galeri baru --}}
    <form action="{{ route('admin.galeri.store') }}" method="POST" enctype="multipart/form-data" id="formGaleri">
        ...
        <div class="hp-section">
            ...
            <div class="hp-save-bar">
                <span class="hp-save-hint"><i class="fas fa-lock me-1"></i> Data galeri akan langsung tersimpan ke sistem</span>
                <div style="display:flex; gap:10px; align-items:center;">
                    {{-- Tombol batal kembali ke halaman daftar galeri --}}
                    <a href="{{ route('admin.galeri.index') }}" class="hp-btn-cancel">
                        <i class="fas fa-times"></i> Batal
                    </a>
                    {{-- Tombol submit menyimpan data galeri baru --}}
