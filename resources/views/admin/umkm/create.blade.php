...
<div class="ep-wrapper">
    ...
    {{-- Header halaman tambah UMKM dengan tombol kembali --}}
    ...
    {{-- Form tambah UMKM: informasi dasar, gambar, detail tambahan, dan save bar --}}
    {{-- Menggunakan POST dengan enctype multipart untuk upload gambar --}}
    <form action="{{ route('admin.umkm.store') }}" method="POST" enctype="multipart/form-data" id="formUmkm">
        ...
        <div class="hp-section">
            ...
            <div class="hp-section-body">
                {{-- Area upload gambar dengan input file tersembunyi dan preview thumbnail --}}
        ...
        <div class="hp-section">
            ...
            {{-- Save bar dengan tombol batal dan simpan --}}
