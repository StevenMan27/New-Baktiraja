{{--
   ======================================================================================
   [PENJELASAN LENGKAP FILE: a:/PA111/real/New folder/Proyek akhir 1 Real/resources/views/admin/umkm/create.blade.php]
...
<style>
    ...
    /* Warna ikon section lokasi dan kontak kuning */
    ...
    <div class="hp-page-header">
        <div class="hp-page-header-left">
            ...
            <div>
                ...
                <p>Isi nama, geosite, deskripsi, dan detail UMKM</p>
            </div>
        </div>
        {{-- Tombol kembali ke halaman daftar UMKM --}}
        <a href="{{ route('admin.umkm.index') }}" class="hp-btn-back">
            <i class="fas fa-arrow-left"></i> Kembali
        </a>
    </div>

    {{-- Form utama pengiriman data UMKM baru --}}
    <form action="{{ route('admin.umkm.store') }}" method="POST" enctype="multipart/form-data" id="formUmkm">
        @csrf
        ...
        <div class="hp-section">
            <div class="hp-section-header">
                ...
                <div>
                    ...
                    <p>Nama, geosite, dan deskripsi UMKM</p>
                </div>
            </div>
            <div class="hp-section-body">
                ...
                <div>
                    ...
                    <textarea name="deskripsi"
                        ...
                        rows="4"
                        placeholder="Masukkan deskripsi UMKM" required>{{ old('deskripsi') }}</textarea>
                    @error('deskripsi')
                        <div class="hp-error"><i class="fas fa-exclamation-circle"></i> {{ $message }}</div>
                    @enderror
                </div>
        ...
        <div class="hp-section">
            ...
            <div class="hp-save-bar">
                <span class="hp-save-hint"><i class="fas fa-lock me-1"></i> Data UMKM akan langsung tersimpan ke sistem</span>
                <div style="display:flex; gap:10px; align-items:center;">
                    {{-- Tombol batal kembali ke halaman daftar UMKM --}}
                    <a href="{{ route('admin.umkm.index') }}" class="hp-btn-cancel">
                        <i class="fas fa-times"></i> Batal
                    </a>
                    {{-- Tombol submit menyimpan data UMKM baru --}}
