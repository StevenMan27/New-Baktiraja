...
{{--
   ======================================================================================
   [PENJELASAN LENGKAP FILE: a:/PA111/real/New folder/Proyek akhir 1 Real/resources/views/admin/umkm/edit.blade.php]
...
<style>
    ...
    /* Warna ikon section detail kontak berwarna kuning */
...
<div class="ep-wrapper">
    ...
    {{-- Banner header halaman dengan tombol kembali ke daftar UMKM --}}
    ...
    <form action="{{ route('admin.umkm.update', $data->id) }}" method="POST" enctype="multipart/form-data" id="formUmkm">
        ...
        {{-- Section deskripsi UMKM berisi textarea penjelasan usaha --}}
        <div class="hp-section">
            <div class="hp-section-header">
                <div class="section-icon icon-desc"><i class="fas fa-align-left"></i></div>
                <div>
                    <h6>Deskripsi UMKM</h6>
                    <p>Penjelasan singkat mengenai usaha ini</p>
                </div>
            </div>
            <div class="hp-section-body">
                <div>
        ...
        {{-- Section detail kontak berisi lokasi dan nomor kontak UMKM --}}
        <div class="hp-section">
            <div class="hp-section-header">
                <div class="section-icon icon-detail"><i class="fas fa-map-marker-alt"></i></div>
                <div>
                    <h6>Detail Kontak</h6>
                    <p>Lokasi dan informasi kontak UMKM</p>
                </div>
            </div>
            <div class="hp-section-body">
                <div class="hp-grid-2">
        ...
        {{-- Section upload gambar UMKM berisi gambar lama dan area upload baru --}}
        <div class="hp-section">
            <div class="hp-section-header">
            ...
            <div class="hp-save-bar">
                ...
                <div style="display:flex; gap:10px; align-items:center;">
                    ...
                    {{-- Tombol submit menyimpan perubahan data UMKM --}}
