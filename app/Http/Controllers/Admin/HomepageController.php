...
class HomepageController extends Controller
{
    ...
    public function update(Request $request)
    {
        ...
        // Memisahkan data file dari data teks agar bisa diproses terpisah
        $data = $request->except(['_token', '_method', 'hero_slide_1', 'hero_slide_2', 'hero_slide_3', 'hero_slide_4', 'hero_slide_5', 'about_video']);
